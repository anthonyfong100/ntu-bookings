...
class WebDriverWrapper:
    def __init__(
        self, download_location=None, chrome_browser_location=None,
    ):
        ...
        if chrome_browser_location:
            chrome_options.binary_location = chrome_browser_location
            self._driver = webdriver.Chrome(
                chrome_browser_location, chrome_options=chrome_options
            )
        else:
            chrome_options.binary_location = (
                os.getcwd() + "/bin/headless-chromium"
            )
    ...
    def enable_download_in_headless_chrome(self):
        ...
        params = {
            ...
            "params": {
                "behavior": "allow",
                "downloadPath": self.download_location,
            },
        }
